        ...
        <div class="card-body">
            <div class="container mb-5 mt-3">
                ...
                <div class="col-xl-2">
                    ...
                    <?php endif; ?>
                    <form class="form-control me-2" action="<?php echo e(route('vente.search')); ?>" method="GET" role="search">
                            ...
                            <?php if(count($temps) > 0): ?>
                                <li class="text-muted"><i class="fas fa-circle" style="color:#84B0CA ;"></i> <span
                                        class="fw-bold"><input class="form-control me-2" type="date" name="date_vente"
                                            value="<?php echo e($temps[0]->date_vente); ?>" required></li>
                            <?php else: ?>
                                <li class="text-muted"><i class="fas fa-circle" style="color:#84B0CA ;"></i> <span
                                        class="fw-bold"><input class="form-control me-2" type="date" name="date_vente"
                            ...
                            <li class="text-muted">
                                ...
                                <i class="fas fa-circle" style="color:#84B0CA ;"> السعر</i> <span class="fw-bold">
                                    <input class="form-control me-2" type="number" min=0 step="0.01"
                                        placeholder="السعر" aria-label="البحث" name="prix_vente" required value=<?php echo e(old('prix_vente')); ?>>
            ...
            <div class="row my-2 mx-1 justify-content-center">
                <table class="table table-striped table-borderless">
                    ...
                    <tbody>
                        <tr>
                            <?php $__currentLoopData = $temps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $temp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <td><?php echo e($temp->prix_vente); ?></td>
                                <?php if($temp->sexe == 1): ?>
                                    <td>ذكر</td>
                                <?php else: ?>
                                    <td>أنثى</td>
                    ...
                    <tr>
                        ...
                        <td>  كباش: <?php echo e($nombremale); ?> | نعاج:</span><?php echo e($nombrefemale); ?>|خراف  :<?php echo e($nombreagneaux); ?></td>
                        <td>...</td>
                        <td>...</td>
                    </tr>
                    </tbody>
            ...
            <div class="row">
                ...
                <div class="col-xl-2">
                    ...
                    href="<?php echo e(route('vente.valider')); ?>">تأكيد البيع
                        </a>
...
<?php echo $__env->make('layouts.menu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH K:\laraval\AppOvins\resources\views/ventes/vente.blade.php ENDPATH**/ ?>