...
<head>
    ...
    <body>
        <form action="<?php echo e(route('ovins.addnaissance', $ovin->id)); ?>" method="post">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts/menu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH K:\laraval\AppOvins\resources\views/ovins/naissance.blade.php ENDPATH**/ ?>