...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col">
            ...
            <input type="date" class="form-control" name="date_achat" value="{{ $ovin->date_achat }}" readonly='readonly'>
        </div>
        <div class="col">
            <label for="date_vente">تاريخ البيع/الإعادة : </label>
            <input type="date" class="form-control" name="date_vente" value="{{ $date_vente }}" readonly='readonly'>
        </div>
        <div class="col">
            <label for="date_naissance">تاريخ الميلاد : </label>
            <input type="date" class="form-control" name="date_naissance" value="{{ $ovin->date_naissance }}" readonly='readonly'>
        </div>
        <div class="col">
            <label for="die_date">تاريخ النفوق : </label>
            <input type="date" class="form-control" name="die_date" value="{{ $ovin->die_date }}" readonly='readonly'>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col">
            ...
            <input type="number" class="form-control" name="poid" value="{{ $ovin->poid }}" placeholder="الوزن" readonly='readonly'>
        </div>
    </div>
...
<div class="row">
    <a class="btn btn-success" href="{{ route('ovins.edit', $ovin->id) }}" role="button">تعديل</a>
</div>
@endsection