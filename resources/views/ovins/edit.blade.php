...
<div class="container">
    <form action="{{ route('ovins.update', $ovin->id) }}" method="post">
        ...
        <div class="row">
            ...
            <div class="col">
                <label for="date_inventaire">تاريخ التحديث : </label>
                <input type="date" class="form-control" name="date_inventaire" value="{{ $ovin->date_inventaire }}">

            </div>
            <div class="col">
                <label for="inventaire">الحالة  : </label>
                <input type="text" class="form-control" name="inventaire" value="{{ $ovin->inventaire }}">
